    ...
    <div className="bg-primary text-primary-text min-h-screen">
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="bg-secondary/50 border-secondary-text/10 space-y-8 rounded-lg border p-8 backdrop-blur-sm">
          ...
          <section>
            <h2 className="text-primary-text mb-4 text-2xl font-semibold">
              3. Interview Data and Recordings
            </h2>
            <p className="text-secondary-text leading-relaxed">
              Your interview sessions are recorded and analyzed using AI
              technology to provide feedback. These recordings are securely
              stored and used solely for the purpose of generating your
              personalized feedback report. We do not share your interview
              recordings with third parties without your explicit consent.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-secondary-text leading-relaxed">
              ...
              active or as needed to provide you services. Interview recordings
              are typically retained for 90 days unless you request earlier
              deletion.
            </p>
          </section>
