...
describe('AudioRecorder', () => {
  ...
  describe('start', () => {
    ...
    it('should add audio worklet module', async () => {
      ...
      expect(mockAudioContext.audioWorklet.addModule).toHaveBeenCalledWith('/audio-processor.js');
    });
  });
  ...
  describe('permission handling', () => {
    it('should handle permission denial', async () => {
      ...
      await expect(audioRecorder.start(onAudioData)).rejects.toThrow('Permission denied');
    });
  });
});