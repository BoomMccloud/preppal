  ...
  const transcriptEntries = [
    {
      speaker: "AI",
      content:
        "Hello! Welcome to your interview for the Senior Frontend Developer position at TechVentures Inc. I'm excited to learn more about your experience. Let's start with an introduction - can you tell me about your background and what interests you about this role?",
...
- Could have prepared a more organized workspace for coding demonstrations`,
  ...
  console.log(
    "  • demo-pending-789 (PENDING) - Staff Software Engineer (long description)",
  );
  ...
  console.log("\n🌐 Try these URLs:");
  console.log(
    "  • /interview/demo-123/lobby → redirects to feedback (COMPLETED)",
  );
  console.log("  • /interview/demo-123/feedback → view feedback");
  console.log("  • /interview/demo-pending-456/lobby → shows lobby (PENDING)");
  console.log(
    "  • /interview/demo-pending-789/lobby → shows lobby with truncation",
  );
  console.log(
    "  • /interview/demo-in-progress-321/lobby → shows error (IN_PROGRESS)",
  );
